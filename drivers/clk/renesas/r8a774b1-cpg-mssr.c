...
static const struct cpg_core_clk r8a774b1_core_clks[] __initconst = {
	...
	/* Core Clock Outputs */
	DEF_GEN3_Z("z",		R8A774B1_CLK_Z,  CLK_TYPE_GEN3_Z,  CLK_PLL0, 2),
	DEF_GEN3_Z("zg",	R8A774B1_CLK_ZG, CLK_TYPE_GEN3_ZG, CLK_PLL4, 4),
...
static const struct mssr_mod_clk r8a774b1_mod_clks[] __initconst = {
	...
	DEF_MOD("tpu",			 304,	R8A774B1_CLK_S3D4),
